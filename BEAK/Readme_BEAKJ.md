...
|날짜 계산|1476|O||
|테트로미노|14500||진행X|
|1, 2, 3 더하기|9095|X , O|순열X재귀O|
|다음 순열|10972 |O|NEXT_PERMU 구현연습 |
|이전 순열|10973 |O|STL함수 가져다씀 |
|모든 순열|10974 |O,X|다른방식(재귀?) |
|차이를 최대로|10819 |X,X |답이틀림,20이순회 |
|외판원 순회 2|10971 |X |따라쳐서 풀음|
|로또|6603 |X |강의보고 어거지로 풀음 |
|연산자 끼워넣기|14888 | | |
|암호 만들기|1759 |X |런타임에러 |
|부분집합의 합|1182 |X,X |재귀, 비트마스크 |
|퇴사|14501| |
|연산자 끼워넣기2|15658||
|집합|11723|X |답이틀림|

>브루트 포스 (N과 M 연습) - [알고리즘 문제 Link](https://code.plus/course/32)
